# Google Play store listing — 2.0.0

Тексты для обновления карточки Play (issue #29). Изображения лежат рядом
(icon-512.png, feature-graphic.png, 1-phone.png … 6-phone.png — см. README.md).
Тексты ниже копируются в Play Console.

## Default listing (English)

### Short description (≤80 chars)

Speak Turkmen in real situations — 295 phrases, 13 scenarios, offline.
...
Туркменский разговорник для реальных ситуаций: 295 фраз, 13 сценариев, офлайн.
...
• Полностью офлайн
• Новая иконка и более чистый интерфейс

Для путешественников по Туркменистану и гостей страны.

Отзывы и предложения: shapak.apps@gmail.com
